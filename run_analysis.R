##Code to pull file from the interent starts here; 
##Comment below lines if you do not wish to download the Zip file
url<-"https://d396qusza40orc.cloudfront.net/getdata%2Fprojectfiles%2FUCI%20HAR%20Dataset.zip"
setwd(tempdir())
zipFile<-"Dataset.zip"
download.file(url,zipFile)
unzip(zipFile)
parentDir<-paste(tempdir(),"\\UCI HAR Dataset",sep="")
setwd(parentDir)
##Code to pull file from the interent ends here
